<div class="postbox">
	<h2 class="hndle">
		<span><?=__( 'Basic setting', 'loos-ssp' )?></span>
	</h2>
	<div class="inside">
...
<?php $table_rows = [
	...
	'home_title' => [
		...
		'prev'        => true,
		'desc'        => sprintf(
			__( 'It is the setting of %s that is output to the home page.', 'loos-ssp' ),
			'<code>&lt;title&gt;</code> ' . __( 'tag', 'loos-ssp' )
...
// 特殊なもの
foreach ( SSP_Data::SEPARATORS as $key => $sep ) {
